package com.example.imoocsdk.okhttp;

import com.example.imoocsdk.okhttp.cookie.SimpleCookieJar;
import com.example.imoocsdk.okhttp.https.HttpsUtils;
import com.example.imoocsdk.okhttp.listener.DisposeDataHandle;
import com.example.imoocsdk.okhttp.response.CommonFileCallback;
...
public class CommonOkHttpClient {
    ...
    static {
        ...
        okHttpClientBuilder.followRedirects(true);//允许请求转发或者重定向
        /**
